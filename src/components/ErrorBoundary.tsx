      ...
      <div style={{ minHeight: "100vh", background: "#000", display: "flex", alignItems: "center", justifyContent: "center", padding: "2rem" }}>
        <div style={{ maxWidth: "480px", width: "100%" }}>
          ...
          <div style={{ background: "#0a0a0a", border: "1px solid #1a1a1a", padding: "1rem 1.25rem", marginBottom: "2rem" }}>
            <p style={{ ...mono, fontSize: "0.75rem", color: "#5a5a5a", lineHeight: 1.7 }}>
          ...
          <button
            style={{ ...mono, marginTop: "1rem", width: "100%", background: "none", border: "none", color: "#3d3d3d", fontSize: "0.75rem", cursor: "pointer", textTransform: "uppercase", letterSpacing: "0.08em" }}
